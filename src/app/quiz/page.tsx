...
const MAX_SETS=2
const QS=[{q:'ケイ素（シリカ）は体内でどんな役割をしますか？',o:['骨を硬くするだけ','コラーゲンを結びつけて弾力を作る','カルシウムを補給する','水分を排出する'],a:1,e:'ケイ素はコラーゲン・エラスチン・ヒアルロン酸を接着剤のように結びつけ、お肌や血管の弾力を保ちます。',d:'easy'},{q:'日本人の何割がミネラル不足と言われていますか？',o:['約3割','約5割','約7割','約9割'],a:3,e:'日本人の約9割がミネラル不足と言われています。これが美容・健康の悩みにつながっています。',d:'easy'},{q:'健康な人の血液のpH値として正しいものはどれですか？',o:['pH6.0（弱酸性）','pH7.0（中性）','pH7.4（弱アルカリ性）','pH8.0（アルカリ性）'],a:2,e:'健康な人の血液はpH7.4±0.05の弱アルカリ性に保たれています。',d:'easy'},{q:'体温が1℃下がると免疫力はどのくらい低下しますか？',o:['約10%','約20%','約30%','約50%'],a:2,e:'体温が1℃下がると免疫力は約30%、代謝は約12%低下すると言われています。',d:'easy'},{q:'ホワイトシリカを飲む場合の推奨希釈倍率は？',o:['10〜20倍','50倍','100〜200倍','500倍以上'],a:2,e:'ホワイトシリカは100〜200倍に希釈して飲むのが推奨されています。1日の目安は10〜20ccです。',d:'easy'},{q:'水溶性ケイ素の精菌力とはどんな力ですか？',o:['菌を全部殺す力','菌のバランスを整える力','菌を増やす力','体を守るバリア'],a:1,e:'精菌力は菌を殺すのではなく、腸や肌の菌バランスを整える力です。殺菌力とは異なります。',d:'easy'},{q:'美肌のために毎日心がけたい生活習慣として最も効果的なものはどれですか？',o:['長時間の日光浴','十分な睡眠・水分補給・バランスの良い食事','激しい運動のみ','高カロリーな食事'],a:1,e:'美肌の基本は十分な睡眠・こまめな水分補給・バランスの良い食事です。これらが肌の新陳代謝を支えます。',d:'easy'},{q:'腸内環境を整えるために効果的な食品はどれですか？',o:['加工食品・インスタント食品','発酵食品（味噌・醤油・納豆）・食物繊維','炭酸飲料・甘い菓子','脂っこい揚げ物'],a:1,e:'発酵食品や食物繊維は腸内の善玉菌を増やし腸内環境を整えます。腸は免疫の約70%を担う重要な臓器です。',d:'easy'},{q:'ケイ素の抗酸化力を示す実験として正しいものはどれですか？',o:['ケイ素を加えると水が早く沸騰する','水道水にケイ素を10%加えると腐らず鉄も錆びない','ケイ素を加えると水が甘くなる','ケイ素で植物が早く育つ'],a:1,e:'水道水にケイ素を10%加えると水自体が腐らなくなり鉄も錆びません。5年・10年経っても酸化しない強力な抗酸化力があります。',d:'easy'},{q:'体を温める陽性食品に分類されるものはどれですか？',o:['きゅうり・ナス・トマト','梅干し・発酵食品・根菜類','アイスクリーム・冷たい飲み物','生野菜サラダ'],a:1,e:'梅干し・発酵食品（味噌・醤油）・根菜類（ごぼう・れんこん）は体を温める陽性食品です。夏野菜は体を冷やす陰性食品です。',d:'easy'},{q:'爪がボコボコしたり縦筋が入る主な原因はどれですか？',o:['爪の切りすぎ','ケイ素不足による弾力低下','紫外線の浴びすぎ','水の飲みすぎ'],a:1,e:'爪のボコボコ・縦筋はケイ素不足のサインのひとつです。ケイ素は爪の弾力を支えています。',d:'easy'},{q:'日焼け後の肌ケアとして正しいものはどれですか？',o:['すぐに熱いお風呂に入る','アルコール入り化粧水をたっぷりつける','冷やして炎症を抑えた後しっかり保湿する','放置してよい'],a:2,e:'日焼けは軽いやけどです。まず冷やして炎症を落ち着かせ、その後しっかり保湿することが大切です。',d:'easy'},{q:'水分補給として最も体に良い飲み物はどれですか？',o:['砂糖入りジュース','カフェイン入りコーヒー','清潔な水（白湯や常温水）','炭酸飲料'],a:2,e:'体の約60%は水分でできています。こまめに清潔な水を飲むことが、代謝・血流・肌の調子を整える基本です。',d:'easy'},{q:'睡眠が不足すると肌に起こりやすいことはどれですか？',o:['肌が明るくなる','くすみ・乾燥・ニキビが起きやすくなる','毛穴が引き締まる','シミが薄くなる'],a:1,e:'睡眠中は成長ホルモンが分泌され肌の修復が行われます。睡眠不足は新陳代謝を妨げくすみ・乾燥・ニキビの原因になります。',d:'easy'},{q:'ホワイトシリカを加熱するとどうなりますか？',o:['毒素が発生する','性質が変わらないので料理にも使える','効果がなくなる','色が変わる'],a:1,e:'ホワイトシリカは加熱しても性質が変わりません。料理に加えて加熱調理することもできます。',d:'easy'},{q:'シリカゲル（乾燥剤）はどんな物質でできていますか？',o:['炭素','カルシウム','ケイ素（シリカ）','マグネシウム'],a:2,e:'お菓子などに入っている乾燥剤シリカゲルはケイ素（Silica）でできています。ケイ素の無数の穴に水分を吸着します。',d:'easy'},{q:'血液を弱アルカリ性に保つために効果的な食品はどれですか？',o:['砂糖・白米・お肉','大根・にんじん・根菜類','コーヒー・お酒・チョコレート','牛乳・乳製品'],a:1,e:'大根・にんじん・れんこんなどの根菜類はアルカリ性食品で血液をきれいにする働きがあります。',d:'easy'},{q:'ケイ素の脂肪溶解力の実験で確認できることはどれですか？',o:['水と脂が完全に分離する','ケイ素を加えると水と脂が乳化して長期間固まらない','脂がより固まる','水が蒸発する'],a:1,e:'ケイ素を加えると水と脂が乳化（エマルジョン化）し1ヶ月経っても固まりません。血管内のプラーク防止にも期待されます。',d:'easy'},{q:'食物繊維やケイ素が特に多く含まれる食材の部位はどこですか？',o:['果肉の中心','種の部分','皮の部分','根の先端'],a:2,e:'食物繊維やケイ素は主に皮の部分に多く含まれています。現代食では皮を除くことが多く不足しがちです。',d:'easy'},{q:'髪の毛を健康に保つために特に重要なミネラルはどれですか？',o:['ナトリウム','塩素','ケイ素（シリカ）','リン'],a:2,e:'ケイ素は髪・爪・肌の弾力を作る重要なミネラルです。不足すると白髪・脱毛・爪のトラブルが起きやすくなります。',d:'easy'},{q:'1日の適切な水分摂取量として正しいものはどれですか？',o:['約500ml','約1〜1.5L','約2〜2.5L','約4L以上'],a:2,e:'成人の1日の推奨水分摂取量は約2〜2.5Lです。食事からの水分も含みますが、飲み水として1.5〜2L程度を目安にしましょう。',d:'easy'}]
...
async function startQuiz(){
  ...
  setQs(shuffle(QS).slice(0,5) as typeof QS);setQi(0);setScore(0);setXpGain(0);setAns(false);setSel(null);setFb('');setSc('quiz')
}
function pick(idx:number){if(ans)return;setAns(true);setSel(idx);const q=qs[qi];const ok=idx===q.a;if(ok){setScore(s=>s+1);setXpGain(x=>x+2)}else{setXpGain(x=>Math.max(0,x-1))};setFb(ok?'✅ 正解！':('❌ 不正解 → 正解：'+q.o[q.a]))}
async function next(){
  if(qi+1>=qs.length){
    setSaving(true)
...
return(<div style={{minHeight:'100vh',background:'linear-gradient(160deg,#b8eaff 0%,#e8f9ff 50%,#fffbe6 100%)',fontFamily:"'M PLUS Rounded 1c',sans-serif",padding:'20px 16px 60px'}}>
...
{sc==='login'&&<div style={{background:'white',borderRadius:20,padding:24,boxShadow:'0 8px 32px rgba(59,191,239,0.18)'}}>
  ...
  <button onClick={login} disabled={logging} style={{width:'100%',padding:14,background:'linear-gradient(135deg,#3bbfef,#1a8cc7)',color:'white',border:'none',borderRadius:14,fontSize:'1rem',fontWeight:900,cursor:'pointer',fontFamily:'inherit',marginBottom:12}}>
    {logging?'確認中...':'ログイン 🚀'}</button>
...
{sc==='home'&&<div>
  <div style={{background:'white',borderRadius:20,padding:24,boxShadow:'0 8px 32px rgba(59,191,239,0.18)',textAlign:'center',marginBottom:16}}>
    ...
    <p style={{color:'#6b7f92',fontSize:'0.85rem',marginBottom:14}}>累計 <strong style={{color:'#1a8cc7',fontSize:'1.2rem'}}>{user?.total_xp||0} XP</strong></p>
  ...
  {ranking.length>0&&<div style={{background:'white',borderRadius:20,padding:'16px 18px',boxShadow:'0 8px 32px rgba(59,191,239,0.18)'}}>
    ...
    <p style={{fontSize:'0.72rem',color:'#aab',textAlign:'center',marginTop:8}}>🎁マーク（4・5位）もプレゼント対象！</p>
  </div>}
</div>}
{sc==='quiz'&&q&&<div>
  <div style={{display:'flex',gap:8,marginBottom:12}}>
    {[{n:score,l:'正解'},{n:(qi+1)+'/5',l:'問目'},{n:xpGain,l:'獲得XP'}].map((s,i)=>(<div key={i} style={{flex:1,background:'white',borderRadius:12,padding:'8px',textAlign:'center',boxShadow:'0 2px 8px rgba(0,0,0,0.07)'}}><div style={{fontSize:'1.2rem',fontWeight:900,color:'#1a8cc7'}}>{s.n}</div><div style={{fontSize:'0.65rem',color:'#6b7f92'}}>{s.l}</div></div>))}
  </div>
...
{sc==='result'&&<div style={{background:'white',borderRadius:20,padding:24,boxShadow:'0 8px 32px rgba(59,191,239,0.18)',textAlign:'center'}}>
  ...
  <div style={{background:'linear-gradient(135deg,#e8f9ff,#fffbe6)',borderRadius:14,padding:'14px 16px',marginBottom:16}}>
    <p style={{margin:0,fontWeight:800,color:'#1a8cc7',fontSize:'1.1rem'}}>+{xpGain} XP 獲得！</p>
