...
{rank:4,icon:'4️⃣',award:'４位・フードケア賞',items:'びおすーぷ・乳酸菌シリカジュレ・超濃縮海洋ミネラル水',price:'約14,000円相当',img:BASE+'004.png',color:'#f0faff',border:'#b0d8ff',badge:'#1a8cc7'},
{rank:5,icon:'5️⃣',award:'５位・マインドケア賞',items:'ブルーシリカ（176g）',price:'約77,000円相当',img:BASE+'006.png',color:'#f0fff4',border:'#9fe1cb',badge:'#0f6e56'},
]
